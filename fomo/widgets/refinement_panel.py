...
class RefinementSidePanel(QtWidgets.QSplitter):
    ...
    def _build_initial_avg_section(self):
        ...
        v.addWidget(self.calc_initial_btn)
    ...
    def _build_numeric_params_section(self):
        ...
        self.shift_x = QtWidgets.QSpinBox(); self.shift_x.setValue(4)
        self.shift_y = QtWidgets.QSpinBox(); self.shift_y.setValue(4)
        self.shift_z = QtWidgets.QSpinBox(); self.shift_z.setValue(12)
