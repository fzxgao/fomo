...
class RefinementSidePanel(QtWidgets.QSplitter):
    ...
    def _build_numeric_params_section(self):
        ...
        self.iterations.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.iterations.setValue(4)
        _disable_scroll(self.iterations)
        form.addRow("Iterations", self.iterations)
        # 2 References
        self.references = QtWidgets.QSpinBox()
        self.references.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.references.setValue(1)
        _disable_scroll(self.references)
        form.addRow("References", self.references)
        # 3 Cone Aperture
        self.cone_aperture = QtWidgets.QSpinBox()
        self.cone_aperture.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.cone_aperture.setValue(45)
        _disable_scroll(self.cone_aperture)
        form.addRow("Cone Aperture", self.cone_aperture)
        # 4 Cone Sampling
        self.cone_sampling = QtWidgets.QSpinBox()
        self.cone_sampling.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.cone_sampling.setValue(15)
        _disable_scroll(self.cone_sampling)
        form.addRow("Cone Sampling", self.cone_sampling)
        # 5 Azimuth Rotation Range
        self.az_rot_range = QtWidgets.QSpinBox()
        self.az_rot_range.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.az_rot_range.setValue(60)
        _disable_scroll(self.az_rot_range)
        form.addRow("Azimuth Rotation Range", self.az_rot_range)
        # 6 Azimuth Rotation Sampling
        self.az_rot_sampling = QtWidgets.QSpinBox()
        self.az_rot_sampling.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.az_rot_sampling.setValue(15)
        _disable_scroll(self.az_rot_sampling)
        form.addRow("Azimuth Rotation Sampling", self.az_rot_sampling)
        # 7 Refine
        self.refine = QtWidgets.QSpinBox()
        self.refine.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.refine.setValue(2)
        _disable_scroll(self.refine)
        form.addRow("Refine", self.refine)
        # 8 Refine Factor
        self.refine_factor = QtWidgets.QSpinBox()
        self.refine_factor.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.refine_factor.setValue(2)
        _disable_scroll(self.refine_factor)
        form.addRow("Refine Factor", self.refine_factor)
        # 9 High Pass
        self.high_pass = QtWidgets.QSpinBox()
        self.high_pass.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.high_pass.setValue(1)
        _disable_scroll(self.high_pass)
        form.addRow("High Pass", self.high_pass)
        #10 Low Pass
        self.low_pass = QtWidgets.QSpinBox()
        self.low_pass.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.low_pass.setValue(12)
        _disable_scroll(self.low_pass)
        ...
        self.particle_dims = QtWidgets.QSpinBox()
        self.particle_dims.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.particle_dims.setValue(40)
        _disable_scroll(self.particle_dims)
        form.addRow("Particle Dimensions", self.particle_dims)
        #13 Shift limits
        shift_widget = QtWidgets.QWidget()
        sh = QtWidgets.QHBoxLayout(shift_widget)
        self.shift_x = QtWidgets.QSpinBox()
        self.shift_x.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.shift_x.setValue(4)
        self.shift_x.setMinimumWidth(30)
        _disable_scroll(self.shift_x)
        self.shift_y = QtWidgets.QSpinBox()
        self.shift_y.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.shift_y.setValue(4)
        self.shift_y.setMinimumWidth(30)
        _disable_scroll(self.shift_y)
        self.shift_z = QtWidgets.QSpinBox()
        self.shift_z.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.shift_z.setValue(12)
        self.shift_z.setMinimumWidth(30)
        _disable_scroll(self.shift_z)
        ...
        _disable_scroll(self.shift_way)
        form.addRow("Shift limiting way", self.shift_way)
        #15 Separation in Tomogram
        self.separation = QtWidgets.QSpinBox()
        self.separation.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.separation.setValue(20)
        _disable_scroll(self.separation)
        form.addRow("Separation in Tomogram", self.separation)
        #16 Basic MRA
        self.basic_mra = QtWidgets.QSpinBox()
        self.basic_mra.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.basic_mra.setValue(0)
        _disable_scroll(self.basic_mra)
        form.addRow("Basic MRA", self.basic_mra)
        #17 Threshold parameter
        self.threshold_param = QtWidgets.QDoubleSpinBox()
        self.threshold_param.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.threshold_param.setValue(0.2)
        _disable_scroll(self.threshold_param)
